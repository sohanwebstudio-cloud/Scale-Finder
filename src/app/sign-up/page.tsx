    ...
    <div className="flex min-h-[60vh] items-center justify-center py-12">
      <div className="w-full max-w-sm border border-ink bg-paper">
        <div className="border-b border-ink px-6 py-5">
          ...
          <h1 className="text-[15px] font-bold uppercase tracking-[0.15em]">Créer un compte</h1>
        </div>
        ...
        <div className="border-t border-ink px-6 py-3">
          <p className="text-[12px] text-neutral-500">
            Déjà un compte ?{' '}
            <Link href="/sign-in" className="font-semibold text-riso-pink-deep hover:underline">
              Se connecter
            </Link>
          </p>
        </div>
